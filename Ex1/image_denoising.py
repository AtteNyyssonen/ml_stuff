...
# Extract required element and vectors
sigma0 = S[0]
u0 = U[:,0]
v0t = Vh[0,:]
# Calculate v and h^t
v = np.sqrt(sigma0)*u0
ht = np.sqrt(sigma0)*v0t

first_imns = conv1(imns, ht, axis=1, mode='reflect')
first_imng = conv1(imng, ht, axis=1, mode='reflect')
gflt_imns = conv1(first_imns, v, axis=0, mode='reflect')
gflt_imng = conv1(first_imng, v, axis=0, mode='reflect')
##--your-code-ends-here--##
