...
# These parameters gave the result of tracking both runners for the first few frames
# and then only tracking the runner on the right for few frames longer.
...
while cv2.waitKey(delay) != ord('q'):
    try:
        ...
        for i in range(len(detections)):
            ...
            (x, y, w, h) = [elem for elem in cartes]
