...
#--your-code-starts-here--##
x1 = coords.get("x1") # replace me
x2 = coords.get("x2") # replace me 
y1 = coords.get("y1") # replace me 
y2 = coords.get("y2") # replace me 
#--your-code-ends-here--##
...
##-your-code-starts-here-##
ABCDEFGH_h = np.hstack((ABCDEFGH_w, np.ones((8, 1))))

proj1 = (P1t @ ABCDEFGH_h.T).T
cx1 = proj1[:, 0] / proj1[:, 2]
cy1 = proj1[:, 1] / proj1[:, 2]

proj2 = (P2t @ ABCDEFGH_h.T).T
cx2 = proj2[:, 0] / proj2[:, 2]
cy2 = proj2[:, 1] / proj2[:, 2]
...
##-your-code-starts-here-##
Xc_h = np.vstack((Xc, np.ones((1, 8))))

proj1_rec = (P1 @ Xc_h).T
pcx1 = proj1_rec[:, 0] / proj1_rec[:, 2] 
pcy1 = proj1_rec[:, 1] / proj1_rec[:, 2]

proj2_rec = (P2 @ Xc_h).T
pcx2 = proj2_rec[:, 0] / proj2_rec[:, 2]
pcy2 = proj2_rec[:, 1] / proj2_rec[:, 2]
##-your-code-starts-here-##
